...
class UsageReportForm(forms.Form):
    ...
    usage_types = forms.MultipleChoiceField(
        choices=[],  # Initialize as empty list
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Dynamically set choices for usage_types to ensure UsageMeter is loaded
        # Import UsageMeter here to avoid circular import issues at module load time
